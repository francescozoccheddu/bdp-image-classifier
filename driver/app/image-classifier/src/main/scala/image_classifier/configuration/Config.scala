...
import ImageFeatureAlgorithm.ImageFeatureAlgorithm
import LogLevel.LogLevel
import TrainingAlgorithm.TrainingAlgorithm
...
sealed abstract class LoadableOrLoad[+LoadableType <: Loadable[_]]
