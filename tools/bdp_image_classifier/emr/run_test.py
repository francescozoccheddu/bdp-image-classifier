...
def _main():
    ...
    parser.add_argument('dataset', metavar='DATASET', type=download.Dataset, default=download.Dataset.test, choices=download.Dataset.choices(), help='the dataset to use')
