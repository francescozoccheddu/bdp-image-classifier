...
import com.github.francescozoccheddu.bdp_image_classifier.configuration.LoadMode.{LoadMode, _}
import com.github.francescozoccheddu.bdp_image_classifier.configuration.Utils.O
