...
import com.github.francescozoccheddu.bdp_image_classifier.utils.FileUtils.logger
...
private[bdp_image_classifier] final class FileUtils(val workingDir: String)(implicit spark: SparkSession) {
...
private[bdp_image_classifier] object FileUtils {
